...
const idade = inventors.sort((inventorA, inventorB) => {
...
const yearsLived = inventors.reduce((totalAnos, inventor) =>  {
  const anos = inventor.passed - inventor.year;
  return totalAnos + anos;
},0)
...
const doMaisVelho = inventors.sort(function(a, b) {
  const lastInventor = a.passed - a.year;
  const nextInventor = b.passed - b.year;
  return lastInventor > nextInventor ? -1 : 1;
});
console.table(doMaisVelho);
